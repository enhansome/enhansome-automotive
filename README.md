...
* [as](https://github.com/autoas/as) ⭐ 916 | 🐛 3 | 🌐 C | 📅 2026-08-16 ![github] - Automotive software(OSEK & AUTOSAR) and its tool-chain.
* [autosar](https://github.com/cogu/autosar) ⭐ 500 | 🐛 5 | 🌐 Python | 📅 2026-08-10 ![github] - A set of python modules for working with AUTOSAR XML files.
...
* [Trampoline](https://github.com/TrampolineRTOS/trampoline) ⭐ 743 | 🐛 21 | 🌐 C | 📅 2025-09-15 ![github] - Implementation (LGPL license).
* [FreeOSEK](https://github.com/ciaa/firmware_v1) ⭐ 129 | 🐛 103 | 🌐 C | 📅 2020-10-29 ![github] - Implementation (BSD license).
* [Chalandi Amine OSEK 2.2.3](https://github.com/Chalandi/OSEK) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2023-05-17 ![github] -  Implementation for ARM Cortex M3.
...
* [Awesome Autonomous Vehicles](https://github.com/manfreddiaz/awesome-autonomous-vehicles) ⭐ 2,389 | 🐛 1 | 📅 2024-03-15 ![awesome]
* [Awesome Autonomous Driving](https://github.com/autonomousdrivingkr/Awesome-Autonomous-Driving) ⭐ 611 | 🐛 0 | 📅 2026-07-14 ![awesome]
...
* [vsomeip in 10 minutes](https://github.com/GENIVI/vsomeip/wiki/vsomeip-in-10-minutes) ⭐ 1,434 | 🐛 47 | 🌐 C++ | 📅 2026-08-14 - Introduction to SOME/IP based on GENIVI implementation.
...
* [Awesome Vehicle Security](https://github.com/jaredthecoder/awesome-vehicle-security) ⭐ 4,446 | 🐛 2 | 📅 2026-05-30 ![awesome] - Books, hardware, software, applications, car hacking and more.
...
* [Awesome Software Architecture](https://github.com/simskij/awesome-software-architecture) ⭐ 2,864 | 🐛 1 | 📅 2026-04-19 ![awesome]
...
* [Awesome C++](https://github.com/fffaraz/awesome-cpp#readme) ⭐ 72,780 | 🐛 312 | 📅 2026-08-04 ![awesome]
* [Awesome Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 8,986 | 🐛 2 | 📅 2026-08-12 ![awesome]
...
* [Awesome Software Quality](https://github.com/ligurio/awesome-software-quality#readme) ⭐ 2,322 | 🐛 0 | 📅 2023-02-01 ![awesome]

### Unit tests

* [Google Test](https://github.com/google/googletest) ⭐ 38,930 | 🐛 490 | 🌐 C++ | 📅 2026-08-16 ![github] - Google's C++ test framework.
* [Googletest Mocking (gMock) Framework](https://github.com/google/googletest/tree/master/googlemock) ⭐ 38,930 | 🐛 490 | 🌐 C++ | 📅 2026-08-16 ![github] - Google's framework for writing and using C++ mock classes.
...
* [Awesome Static Analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,737 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 ![awesome]
...
* [Free Programming Books](https://github.com/sindresorhus/awesome) ⭐ 496,162 | 🐛 100 | 📅 2026-06-30 ![awesome]
